...
namespace Soenneker.Twilio.OpenApiClient.Models
{
    ...
    public partial class InsightsV1CallAnnotation : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Models.InsightsV1CallAnnotation"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.Twilio.OpenApiClient.Models.InsightsV1CallAnnotation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Twilio.OpenApiClient.Models.InsightsV1CallAnnotation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "answered_by", n => { AnsweredBy = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.AnnotationEnumAnsweredBy>(); } },
                { "call_score", n => { CallScore = n.GetIntValue(); } },
                { "call_sid", n => { CallSid = n.GetStringValue(); } },
                { "comment", n => { Comment = n.GetStringValue(); } },
                { "connectivity_issue", n => { ConnectivityIssue = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.AnnotationEnumConnectivityIssue>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.AnnotationEnumAnsweredBy>("answered_by", AnsweredBy);
            writer.WriteIntValue("call_score", CallScore);
            writer.WriteStringValue("call_sid", CallSid);
            writer.WriteStringValue("comment", Comment);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.AnnotationEnumConnectivityIssue>("connectivity_issue", ConnectivityIssue);
