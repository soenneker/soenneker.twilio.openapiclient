...
namespace Soenneker.Twilio.OpenApiClient.Models
{
    ...
    public partial class ProfileEventRequest : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Twilio.OpenApiClient.Models.ProfileEventRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Twilio.OpenApiClient.Models.ProfileEventRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Twilio.OpenApiClient.Models.ProfileEventRequest();
        }
        /// <summary>
