...
namespace Soenneker.Twilio.OpenApiClient.Models
{
    ...
    public partial class ApiV2010AccountCallCallRecording : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecordingEncryptionDetails? EncryptionDetails { get; set; }
#nullable restore
#else
        public global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecordingEncryptionDetails EncryptionDetails { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecording"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecording CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecording();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "encryption_details", n => { EncryptionDetails = n.GetObjectValue<global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecordingEncryptionDetails>(global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecordingEncryptionDetails.CreateFromDiscriminatorValue); } },
                { "error_code", n => { ErrorCode = n.GetIntValue(); } },
                { "price", n => { Price = n.GetDoubleValue(); } },
                { "price_unit", n => { PriceUnit = n.GetStringValue(); } },
                { "sid", n => { Sid = n.GetStringValue(); } },
                { "source", n => { Source = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CallRecordingEnumSource>(); } },
                { "start_time", n => { StartTime = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CallRecordingEnumStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Twilio.OpenApiClient.Models.ApiV2010AccountCallCallRecordingEncryptionDetails>("encryption_details", EncryptionDetails);
            writer.WriteIntValue("error_code", ErrorCode);
            writer.WriteDoubleValue("price", Price);
            writer.WriteStringValue("price_unit", PriceUnit);
            writer.WriteStringValue("sid", Sid);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CallRecordingEnumSource>("source", Source);
            writer.WriteStringValue("start_time", StartTime);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CallRecordingEnumStatus>("status", Status);
