...
namespace Soenneker.Twilio.OpenApiClient.Models
{
    ...
    public partial class WirelessV1Command : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Models.WirelessV1Command"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.Twilio.OpenApiClient.Models.WirelessV1Command CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Twilio.OpenApiClient.Models.WirelessV1Command();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "command_mode", n => { CommandMode = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumCommandMode>(); } },
                { "date_created", n => { DateCreated = n.GetDateTimeOffsetValue(); } },
                { "date_updated", n => { DateUpdated = n.GetDateTimeOffsetValue(); } },
                { "delivery_receipt_requested", n => { DeliveryReceiptRequested = n.GetBoolValue(); } },
                { "direction", n => { Direction = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumDirection>(); } },
                { "sid", n => { Sid = n.GetStringValue(); } },
                { "sim_sid", n => { SimSid = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumStatus>(); } },
                { "transport", n => { Transport = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumTransport>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumCommandMode>("command_mode", CommandMode);
            writer.WriteDateTimeOffsetValue("date_created", DateCreated);
            writer.WriteDateTimeOffsetValue("date_updated", DateUpdated);
            writer.WriteBoolValue("delivery_receipt_requested", DeliveryReceiptRequested);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumDirection>("direction", Direction);
            writer.WriteStringValue("sid", Sid);
            writer.WriteStringValue("sim_sid", SimSid);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumStatus>("status", Status);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.CommandEnumTransport>("transport", Transport);
