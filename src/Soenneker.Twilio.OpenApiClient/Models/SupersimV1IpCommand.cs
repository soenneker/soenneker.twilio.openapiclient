...
namespace Soenneker.Twilio.OpenApiClient.Models
{
    ...
    public partial class SupersimV1IpCommand : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Models.SupersimV1IpCommand"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.Twilio.OpenApiClient.Models.SupersimV1IpCommand CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Twilio.OpenApiClient.Models.SupersimV1IpCommand();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "direction", n => { Direction = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.IpCommandEnumDirection>(); } },
                { "payload", n => { Payload = n.GetStringValue(); } },
                { "payload_type", n => { PayloadType = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.IpCommandEnumPayloadType>(); } },
                { "sid", n => { Sid = n.GetStringValue(); } },
                { "sim_iccid", n => { SimIccid = n.GetStringValue(); } },
                { "sim_sid", n => { SimSid = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.IpCommandEnumStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.IpCommandEnumDirection>("direction", Direction);
            writer.WriteStringValue("payload", Payload);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.IpCommandEnumPayloadType>("payload_type", PayloadType);
            writer.WriteStringValue("sid", Sid);
            writer.WriteStringValue("sim_iccid", SimIccid);
            writer.WriteStringValue("sim_sid", SimSid);
            writer.WriteEnumValue<global::Soenneker.Twilio.OpenApiClient.Models.IpCommandEnumStatus>("status", Status);
