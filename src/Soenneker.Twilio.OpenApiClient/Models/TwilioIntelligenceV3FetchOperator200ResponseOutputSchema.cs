...
namespace Soenneker.Twilio.OpenApiClient.Models
{
    ...
    public partial class TwilioIntelligenceV3FetchOperator200ResponseOutputSchema : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Models.TwilioIntelligenceV3FetchOperator200ResponseOutputSchema"/> and sets the default values.
        /// </summary>
        public TwilioIntelligenceV3FetchOperator200ResponseOutputSchema()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Twilio.OpenApiClient.Models.TwilioIntelligenceV3FetchOperator200ResponseOutputSchema"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Twilio.OpenApiClient.Models.TwilioIntelligenceV3FetchOperator200ResponseOutputSchema CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Twilio.OpenApiClient.Models.TwilioIntelligenceV3FetchOperator200ResponseOutputSchema();
        }
        /// <summary>
