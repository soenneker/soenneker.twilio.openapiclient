...
using Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators
{
    /// <summary>
    /// Builds and executes requests for operations under \twilio_intelligence_v3\v3\ControlPlane\Operators
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class OperatorsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Twilio.OpenApiClient.twilio_intelligence_v3.v3.ControlPlane.Operators.item collection</summary>
        /// <param name="position">The unique identifier (TTID) of the Language Operator.</param>
        ...
        public global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.Item.OperatorsItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.Item.OperatorsItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OperatorsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/twilio_intelligence_v3/v3/ControlPlane/Operators{?pageSize*,pageToken*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OperatorsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/twilio_intelligence_v3/v3/ControlPlane/Operators{?pageSize*,pageToken*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder.OperatorsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder.OperatorsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Twilio.OpenApiClient.Twilio_intelligence_v3.V3.ControlPlane.Operators.OperatorsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a list of Operators for the account, including those not attached to an Intelligence Configuration. This request returns both Twilio-authored and custom language operators.
        /// </summary>
