...
using System;
namespace Soenneker.Twilio.OpenApiClient.Twilio_voice_v3.V3.Transcriptions.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \twilio_voice_v3\v3\Transcriptions\{transcriptionId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithTranscriptionItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Twilio_voice_v3.V3.Transcriptions.Item.WithTranscriptionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTranscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/twilio_voice_v3/v3/Transcriptions/{transcriptionId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Twilio.OpenApiClient.Twilio_voice_v3.V3.Transcriptions.Item.WithTranscriptionItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTranscriptionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/twilio_voice_v3/v3/Transcriptions/{transcriptionId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Twilio.OpenApiClient.Twilio_voice_v3.V3.Transcriptions.Item.WithTranscriptionItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Twilio.OpenApiClient.Twilio_voice_v3.V3.Transcriptions.Item.WithTranscriptionItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
